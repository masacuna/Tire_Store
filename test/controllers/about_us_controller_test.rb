...
class AboutUsControllerTest < ActionController::TestCase
  ...
  test "should create about_u" do
    assert_difference('AboutU.count') do
      post :create, about_u: { contact: @about_u.contact, content: @about_u.content, header: @about_u.header }
    end
  ...
  test "should update about_u" do
    patch :update, id: @about_u, about_u: { contact: @about_u.contact, content: @about_u.content, header: @about_u.header }
    assert_redirected_to about_u_path(assigns(:about_u))
  end
